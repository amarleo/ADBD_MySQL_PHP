...
<table class="styled-table">
  ...
  <h1>Tabla Cliente</h1>
  <tr>
    <th><a class = "table-title" href="cliente.php?column=DNI&order=<?php echo $asc_or_desc; ?>">DNI<i class ="<?php echo $column == 'DNI' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Nombre&order=<?php echo $asc_or_desc; ?>">Nombre<i class ="<?php echo $column == 'Nombre' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Apellidos&order=<?php echo $asc_or_desc; ?>">Apellidos<i class ="<?php echo $column == 'Apellidos' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Email&order=<?php echo $asc_or_desc; ?>">Email<i class ="<?php echo $column == 'Email' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Telefono&order=<?php echo $asc_or_desc; ?>">Teléfono<i class ="<?php echo $column == 'Telefono' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Direccion&order=<?php echo $asc_or_desc; ?>">Direccion<i class ="<?php echo $column == 'Direccion' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th><a class = "table-title" href="cliente.php?column=Codigo_postal&order=<?php echo $asc_or_desc; ?>">Código Postal<i class ="<?php echo $column == 'Codigo_postal' ? '-' . $up_or_down : ''; ?>"></i></a></th>
    <th></th>
    <th></th>
    </tr>
  <?php
...
<?php
  ...
  <tr>
    ...
    <td ><a class = "edit" href="edit.php?id=<?php echo $data['DNI']; ?>">Edit</a></td>
    <td ><a class = "delete" href="delete.php?id=<?php echo $data['DNI']; ?>">Delete</a></td>
  </tr>
